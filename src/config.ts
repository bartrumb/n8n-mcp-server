...
interface Config {
  ...
  cache_ttl: number;
  output_verbosity: 'concise' | 'summary' | 'full';
}
 ...
 */
export function formatOutput(data: any, verbosity?: 'concise' | 'summary' | 'full'): string {
 ...
 */
function simplifyForSummary(data: any): any {
 ...
 */
function simplifyForConcise(data: any): any {
  if (Array.isArray(data)) {
